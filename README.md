...
## Description
ClassroomQuizz est un projet android développer sous Android Studio en Java dont le but est de proposer à l'utilisateur finale de pouvoir repondre à des questions à choix multiple avec un temps donnée, ou alors à une question précise sur l'un des vingts arrondissements de Paris.

## Installation

Pour installer le projet il faut d'abord creer un serveur avec la base SQL classroom_db ainsi que l'API classroom server.
...
Tout les fichier nécessaire sont disponible dans le dossier "Build"
...
# Limites
Ce projet est avant tout un projet à but pédagogique, de ce fait celui-ci est peu complet et beaucoup de fonctionnalité manques dont la plus importante est le multijoueur. Cependant cette fonctionnalité est disponible sur [ClassroomQuizz](https://github.com/espritdufeu/ClassroomQuizz)
